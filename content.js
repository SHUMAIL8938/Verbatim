...
let overlay = null;
const popup =
  document.getElementById("verbatim-popup") || document.createElement("div");
...
// YouTube overlay system
if (isYouTube) {
  console.log("YouTube overlay system initializing");
  ...
  function updateOverlay() {
    ...
    const words = caption.textContent.split(/\s+/).filter((w) => w.trim());
  ...
  console.log("Overlay update loop started");
}
